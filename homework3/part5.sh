...
python plot_csv.py -i part5/temporal_convergence_explicit.csv part5/temporal_convergence_implicit.csv part5/temporal_convergence_crank-nicolson.csv -x 6 -y -2 -t "Temporal Convergence" -o "part5/plots/temporal_convergence.png" -L -l -p 0.7 0.7 0.007