...
def plot_csv():
    ...
    for i, (file, slope_i) in enumerate(zip(file_path, power_law_slope)):
        # Load the data
        df = pd.read_csv(file)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-p', '--power_law_slope', nargs='+', default=None, type=float, help='Reference slope to plot in log-log plot (optional)')
